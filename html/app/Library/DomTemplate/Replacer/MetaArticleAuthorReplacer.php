...
/**
 * MetaArticleAuthorReplacer class
 */
class MetaArticleAuthorReplacer extends AbstractReplacer implements IContentReplacerInterface
{
    ...
    public function getXPath() : string {
        return $this->xpath ?: "//meta[@property='article:author']";
    }
    ...
    public function getTemplateName() : string {
        return $this->tpl ?: 'META_ARTICLE_AUTHOR';
    }
